...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    //var mobilePhoneNoDashRe = /[0-9]{10,11}/;
    var mobilePhoneRe = /\d{3}-?\d{3,4}-?\d{4}/;


    // Combined regex
    //var phoneMatcherRegex = new RegExp(mobilePhoneNoDashRe.source + "|" + mobilePhoneRe.source, 'g');
    var phoneMatcherRegex = new RegExp(mobilePhoneRe.source, 'g');
    ...
    var PhoneMatcher = /** @class */ (function (_super) {
        ...
        PhoneMatcher.prototype.parseMatches = function (text) {
            ...
            while ((match = matcherRegex.exec(text)) !== null) {
                ...
                if (this.testMatch(match[3]) && contextClear) {
